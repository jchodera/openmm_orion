...
warmup.promote_parameter('reporter_interval', promoted_name='w_reporter_interval', default=1000,
...
equil1.promote_parameter('trajectory_interval', promoted_name='eq1_trajectory_interval', default=0,
                         description='Trajectory saving interval')
equil1.promote_parameter('reporter_interval', promoted_name='eq1_reporter_interval', default=1000,
                         description='Reporter saving interval')
...
equil2.promote_parameter('trajectory_interval', promoted_name='eq2_trajectory_interval', default=0,
                         description='Trajectory saving interval')
equil2.promote_parameter('reporter_interval', promoted_name='eq2_reporter_interval', default=1000,
                         description='Reporter saving interval')
...
equil3.promote_parameter('trajectory_interval', promoted_name='eq3_trajectory_interval', default=0,
                         description='Trajectory saving interval')
equil3.promote_parameter('reporter_interval', promoted_name='eq3_reporter_interval', default=1000,
                         description='Reporter saving interval')
